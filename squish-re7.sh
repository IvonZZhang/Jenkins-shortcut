...
# app switch qt qt/5.12.8_gcc-7.3.0-ltcg_64bit
...
export SQUISHRUNNER_TAGS="--tags ~@target --tags ~@T_ULOGR-1346 --tags ~@workinprogress --tags ~@replay --tags ~@deprecated --tags ~@serial --tags ~@listenOnly --tags @core"

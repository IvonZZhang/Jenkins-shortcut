...
set RUN_DASHBOARD=
set RUN_EVI=
set RUN_FLASHFILESYSTEMVIEWER=
set RUN_GENERICMESSAGEVIEW=
set RUN_GRAPHVIEWER=
set RUN_LISTVIEW=
set RUN_MEMORYVIEWER=
set RUN_MESSAGECONSOLE=
set RUN_OBJECTVIEWER=
set RUN_PSMESSAGEVIEWER=
set RUN_RUNTIMEFILTER=
set RUN_SETTINGSMANAGER=
set RUN_TESTMANAGER=
